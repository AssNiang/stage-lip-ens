classdef networkTrafficFTP < comm.internal.ConfigBase & handle
...
%   36.814 specification. For information about the local FTP model, FTP
%   model 2, and FTP model 3, see, respectively, IEEE 802.11ax, 3GPP TR
%   38.814, and 3GPP TR 36.889.
%
...
methods
    ...
    function set.LogNormalMu(obj, value)
        % Validate lognormal mu value
        validateattributes(value, {'numeric'}, {'real', 'scalar', ...
            'finite', '>', 0}, '', 'LogNormalMu');
        obj.LogNormalMu = value;
    end

    function set.LogNormalSigma(obj, value)
        % Validate lognormal sigma value
        validateattributes(value, {'numeric'}, {'real', 'scalar', ...
            'finite', '>', 0}, '', 'LogNormalSigma');
        obj.LogNormalSigma = value;
    end
    ...
    function set.ExponentialMean(obj, value)
        ...
        validateattributes(value, {'numeric'}, {'real', 'scalar', ...
            'finite', 'integer', '>=', 0}, '', 'ExponentialMean');
    ...
    function set.PacketInterArrivalTime(obj, value)
        % Validate packet inter-arrival time value
        validateattributes(value, {'numeric'}, {'real', 'scalar', ...
            'finite', '>=', 0}, '', 'PacketInterArrivalTime');
        obj.PacketInterArrivalTime = value;
    end

    function set.ApplicationData(obj, data)
        % Validate application data
        validateattributes(data, {'numeric'}, {'real', 'integer', ...
            'column', '>=', 0, '<=', 255}, '', 'ApplicationData');
    ...
    function [dt, packetSize, varargout] = generate(obj, varargin)
            ...
            if obj.pNextInvokeTime <= 0
                ...
                if obj.GeneratePacket
                    varargout{1} = obj.pAppData(1:packetSize, 1);
