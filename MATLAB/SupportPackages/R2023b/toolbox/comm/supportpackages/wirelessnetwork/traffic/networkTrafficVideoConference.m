classdef networkTrafficVideoConference < comm.internal.ConfigBase & handle
...
methods
    ...
    function set.FrameSizeUpperLimit(obj, value)
        % Validate frame size upper limit data
        validateattributes(value, {'numeric'}, {'real', 'integer', 'finite', ...
            '>', 0}, '', 'FrameSizeUpperLimit');
        obj.FrameSizeUpperLimit = value;
    end
                ...
                if obj.HasJitter && obj.pSegmentsCount > 1 % Model jitter
                    ...
                    for i = 1:obj.pSegmentsCount
                        while true
                            ...
                            if abs(latencies(i)) <= obj.FrameInterval
                                break;
                            end
                        end
                    end
