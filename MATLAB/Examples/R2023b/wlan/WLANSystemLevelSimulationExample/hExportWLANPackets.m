...
%   Copyright 2022-2023 The MathWorks, Inc.
    ...
    methods(Access = private)
        ...
        function radiotapBytes = formRadiotap(obj, eventData, varargin)
            ...
            if obj.RadiotapFields.dBmTxPower
                ...
                if strcmp(eventData.EventName, "MPDUDecoded")
                    ...
                    txPower = round(eventData.Source.DeviceConfig(capturedPacketdeviceID).TransmitPower,0);
                end
        ...
        function channelBytes = formRadiotapChannelBytes(~,eventData)
            ...
            capturedPacketdeviceID = eventData.Data.DeviceID;
            if eventData.Source.DeviceConfig(capturedPacketdeviceID).BandAndChannel(1) == 5
                channelFlagsHexBits = '0140';
            elseif eventData.Source.DeviceConfig(capturedPacketdeviceID).BandAndChannel(1) == 2.4
