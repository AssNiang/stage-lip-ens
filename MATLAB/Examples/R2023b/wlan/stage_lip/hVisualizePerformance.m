...
%   Copyright 2023 The MathWorks, Inc.
    ...
    methods
        ...
        %%%% --[ADDED BY ASS NIANG <ass.niang@ens-lyon.fr>]--
        % Getter methods for computed metrics
        function avgLatency = getAveragePacketLatency(obj)
            avgLatency = obj.AveragePacketLatency;
        end
        ...
        function packetLossRatio = getPacketLossRatio(obj)
            packetLossRatio = obj.PacketLossRatio;
        end
